...
function HomePage() {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-mesh-luxe flex flex-col relative">
            ...
            {/* Hero Section */}
            <section className="min-h-[90vh] flex flex-col items-center justify-center text-center relative z-10 px-4 pt-10 md:pt-20">
                <motion.div
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative w-24 h-24 md:w-32 md:h-32 mx-auto mb-8 md:mb-12"
                    >
                        <div className="absolute inset-0 bg-primary/20 rounded-[24px] md:rounded-[32px] blur-2xl animate-pulse" />
                        <div className="relative w-full h-full glass-luxe rounded-[24px] md:rounded-[32px] border border-primary/20 flex items-center justify-center overflow-hidden">
                            <motion.div
                                animate={{ y: [0, -5, 0] }}
                            ...
                            >
                                <img
                                    ...
                                    alt="Carrot"
                                    className="w-12 h-12 md:w-16 md:h-16 object-contain drop-shadow-[0_0_15px_rgba(242,127,13,0.5)]"
                                />
                            </motion.div>
            ...
            <section className="py-20 md:py-32 bg-black/20 backdrop-blur-sm relative border-y border-white/5">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 relative">
                        {/* Connecting Line */}
                        <div className="hidden md:block absolute top-[60px] left-[10%] right-[10%] h-[1px] bg-gradient-to-r from-transparent via-white/10 to-transparent" />
                ...
                <div className="max-w-5xl mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <div className="relative group">
                            <div className="absolute inset-0 bg-primary/20 blur-3xl group-hover:bg-primary/30 transition-colors duration-500 opacity-50" />
                            <div className="relative glass-luxe p-2 rounded-[40px] border border-white/10 shadow-2xl overflow-hidden aspect-video">
                                <iframe
            ...
            {/* Tech Specs Section */}
            <section className="py-16 md:py-24 bg-surface-1 border-t border-white/5">
            ...
            <section className="py-20 md:py-40 relative">
                <div className="max-w-4xl mx-auto px-4">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="glass-luxe p-8 md:p-16 rounded-[32px] md:rounded-[48px] border border-primary/20 text-center relative overflow-hidden"
                    >
                        <div className="absolute top-0 right-0 w-32 md:w-64 h-32 md:h-64 bg-primary/10 blur-[80px] -translate-y-1/2 translate-x-1/2" />
                        <div className="absolute bottom-0 left-0 w-24 md:w-48 h-24 md:h-48 bg-accent/5 blur-[60px] translate-y-1/2 -translate-x-1/2" />
            ...
            <footer className="py-8 md:py-12 border-t border-white/5 bg-black/20">
                <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4 text-center md:text-left">
                    <div className="flex items-center gap-3">
                        <img src="/assets/carrot.png" alt="Carrot" className="w-8 h-8 drop-shadow-glow" />
